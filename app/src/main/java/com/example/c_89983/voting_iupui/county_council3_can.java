...
public class county_council3_can extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.county_council_d3);
        listview3 = (ListView) findViewById(R.id.cc3);
        listview4 = (ListView) findViewById(R.id.cc4);
