...
public class house_canditates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.house_canditates);
        listview3 = (ListView) findViewById(R.id.larrybuschon);
        listview4 = (ListView) findViewById(R.id.wtanoos);
