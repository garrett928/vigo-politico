...
public class state_house extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.state_house_can);
        listview3 = (ListView) findViewById(R.id.tonyapaff);
        listview4 = (ListView) findViewById(R.id.eddiefelling);
