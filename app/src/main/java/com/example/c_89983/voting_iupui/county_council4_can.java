...
public class county_council4_can extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.county_council_d4);
        listview3 = (ListView) findViewById(R.id.cc1);
        listview4 = (ListView) findViewById(R.id.cc2);
