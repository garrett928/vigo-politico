...
public class county_commissioner_can extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.county_commissioner);
        listview3 = (ListView) findViewById(R.id.cc9);
        listview4 = (ListView) findViewById(R.id.cc10);
