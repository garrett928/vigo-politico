...
public class county_council1_can extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.county_council_d1);
        listview3 = (ListView) findViewById(R.id.cc7);
        listview4 = (ListView) findViewById(R.id.cc8);
