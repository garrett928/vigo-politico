...
public class senate_canditates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.senate_canditates);
        listview3 = (ListView) findViewById(R.id.mikebraun2);
        listview4 = (ListView) findViewById(R.id.joedonnely);
