...
public class county_council2_can extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.county_council_d2);
        listview3 = (ListView) findViewById(R.id.cc5);
        listview4 = (ListView) findViewById(R.id.cc6);
